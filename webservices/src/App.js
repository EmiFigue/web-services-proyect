...
function App() {
  ...
  return (
    <div className={`App ${isDarkMode ? 'dark-mode' : 'light-mode'} ${isLargeFont ? 'large-font' : ''}`}>
      ...
      <p className={isLargeFont ? 'large-font' : ''}>Busca el clima con el nombre de la ciudad, el código del aeropuerto (IATA) o por número de vuelo.</p>
      ...
      {weatherDeparture && weatherDeparture.weather && weatherDeparture.weather[0] ? (
        ...
        weatherDeparture && <p>No se pudo obtener el clima.</p>
      )}
      ...
      {weatherDestination && weatherDestination.weather && weatherDestination.weather[0] ? (
        ...
        weatherDestination && <p>No se pudo obtener el clima.</p>
